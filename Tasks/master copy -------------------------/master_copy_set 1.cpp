 ...
 */
        //this code is for marshalling and unmarshalling strings, a way of transporting data from one device to another
        //as well as comparing strings , return to 158 for more details
